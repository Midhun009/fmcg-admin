...
const BASE_URL = "http://127.0.0.1:8000/api/state"; // Adjust the URL as needed
...
export const createState = async (enquiryData) => {
  try {
...
export const editState = async (id, enquiryData) => {
  try {
