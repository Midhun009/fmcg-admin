...
const BASE_URL = "http://127.0.0.1:8000/api/packages"; // Adjust the URL as needed
...
export const createPackage = async (enquiryData) => {
  try {
...
export const editPackage = async (id, enquiryData) => {
  try {
...
export const ViewPackageModal = async () => {
  try {
