...
const ProductCategory = () => {
  ...
  const handleAddCategory = async (newCategory) => {
    try {
      ...
      formData.append("seo_title", newCategory.seo_title);
      formData.append("seo_description", newCategory.seo_description);
      formData.append("image_alt", newCategory.image_alt);

      if (newCategory.image) {
        formData.append("image", newCategory.image);
      }

      const addedCategory = await createCategory(formData);
